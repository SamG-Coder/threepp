...
test('DirectGL presents the complete view at high and fractional pixel ratios',{
  ...
  const output=execFileSync(process.execPath,[fileURLToPath(new URL('./raw-gl-pixel-ratio-fixture.mjs',import.meta.url))],{env,encoding:'utf8',timeout:30000});
  assert.match(output,/preserve the complete camera view/);
});
