...
/**
 * Snapshots the deliberately static medieval valley architecture into the native
 * bridge. Camera-visible geometry and the fortress, village, forests and farms share one
...
export function collectStaticReflectionScene(objects, lights = []) {
  ...
  if (indices.length === 0 || positions.length === 0) {
    throw new Error("The Medieval Valley RPG RTX scene contains no static triangles.");
  }
