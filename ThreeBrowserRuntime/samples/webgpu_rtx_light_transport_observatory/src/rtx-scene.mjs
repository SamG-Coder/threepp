...
/**
 * Snapshots the deliberately static observatory architecture into the native
...
export function collectStaticReflectionScene(objects, lights = []) {
  ...
  if (indices.length === 0 || positions.length === 0) {
    throw new Error("The Light Transport Observatory RTX scene contains no static triangles.");
  }
